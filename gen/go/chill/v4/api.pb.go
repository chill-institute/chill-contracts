...
type PlaybackDelivery int32

const (
	PlaybackDelivery_PLAYBACK_DELIVERY_UNSPECIFIED PlaybackDelivery = 0
	PlaybackDelivery_PLAYBACK_DELIVERY_ORIGINAL    PlaybackDelivery = 1
	PlaybackDelivery_PLAYBACK_DELIVERY_HLS         PlaybackDelivery = 2
)

// Enum value maps for PlaybackDelivery.
var (
	PlaybackDelivery_name = map[int32]string{
		0: "PLAYBACK_DELIVERY_UNSPECIFIED",
		1: "PLAYBACK_DELIVERY_ORIGINAL",
		2: "PLAYBACK_DELIVERY_HLS",
	}
	PlaybackDelivery_value = map[string]int32{
		"PLAYBACK_DELIVERY_UNSPECIFIED": 0,
		"PLAYBACK_DELIVERY_ORIGINAL":    1,
		"PLAYBACK_DELIVERY_HLS":         2,
	}
)

func (x PlaybackDelivery) Enum() *PlaybackDelivery {
	p := new(PlaybackDelivery)
	*p = x
	return p
}

func (x PlaybackDelivery) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PlaybackDelivery) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[0].Descriptor()
}

func (PlaybackDelivery) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[0]
}

func (x PlaybackDelivery) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PlaybackDelivery.Descriptor instead.
func (PlaybackDelivery) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	PendingReason_PENDING_REASON_PROCESSING  PendingReason = 1
)
...
const (
	...
	UnavailableReason_UNAVAILABLE_REASON_NOT_FOUND          UnavailableReason = 1
	UnavailableReason_UNAVAILABLE_REASON_UNSUPPORTED_FORMAT UnavailableReason = 2
	UnavailableReason_UNAVAILABLE_REASON_NO_PLAYABLE_SOURCE UnavailableReason = 3
)
...
var (
	UnavailableReason_name = map[int32]string{
		...
		1: "UNAVAILABLE_REASON_NOT_FOUND",
		2: "UNAVAILABLE_REASON_UNSUPPORTED_FORMAT",
		3: "UNAVAILABLE_REASON_NO_PLAYABLE_SOURCE",
	}
	UnavailableReason_value = map[string]int32{
		"UNAVAILABLE_REASON_UNSPECIFIED":        0,
		"UNAVAILABLE_REASON_NOT_FOUND":          1,
		"UNAVAILABLE_REASON_UNSUPPORTED_FORMAT": 2,
		"UNAVAILABLE_REASON_NO_PLAYABLE_SOURCE": 3,
	}
)
...
const (
	...
	TVShowsSource_TV_SHOWS_SOURCE_ALL_PROVIDERS  TVShowsSource = 6
	TVShowsSource_TV_SHOWS_SOURCE_HULU           TVShowsSource = 7
	TVShowsSource_TV_SHOWS_SOURCE_PARAMOUNT_PLUS TVShowsSource = 8
	TVShowsSource_TV_SHOWS_SOURCE_AMC_PLUS       TVShowsSource = 9
	TVShowsSource_TV_SHOWS_SOURCE_PEACOCK        TVShowsSource = 10
)
...
var (
	TVShowsSource_name = map[int32]string{
		...
		6:  "TV_SHOWS_SOURCE_ALL_PROVIDERS",
		7:  "TV_SHOWS_SOURCE_HULU",
		8:  "TV_SHOWS_SOURCE_PARAMOUNT_PLUS",
		9:  "TV_SHOWS_SOURCE_AMC_PLUS",
		10: "TV_SHOWS_SOURCE_PEACOCK",
	}
...
func (CodecFilter) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[12].Descriptor()
}

func (CodecFilter) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[12]
}
...
func (OtherFilter) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[13].Descriptor()
}

func (OtherFilter) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[13]
}
...
func (SearchResultDisplayBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[14].Descriptor()
}

func (SearchResultDisplayBehavior) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[14]
}
...
func (SearchResultTitleBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[15].Descriptor()
}

func (SearchResultTitleBehavior) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[15]
}
...
func (SortBy) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[16].Descriptor()
}

func (SortBy) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[16]
}
...
func (SortDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[17].Descriptor()
}

func (SortDirection) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[17]
}
...
type CatalogSort int32

const (
	CatalogSort_CATALOG_SORT_UNSPECIFIED CatalogSort = 0
	// Default ordering supplied by the selected provider.
	CatalogSort_CATALOG_SORT_POPULARITY        CatalogSort = 1
	CatalogSort_CATALOG_SORT_RATING_DESC       CatalogSort = 2
	CatalogSort_CATALOG_SORT_RATING_ASC        CatalogSort = 3
	CatalogSort_CATALOG_SORT_RELEASE_DATE_DESC CatalogSort = 4
	CatalogSort_CATALOG_SORT_RELEASE_DATE_ASC  CatalogSort = 5
)

// Enum value maps for CatalogSort.
var (
	CatalogSort_name = map[int32]string{
		0: "CATALOG_SORT_UNSPECIFIED",
		1: "CATALOG_SORT_POPULARITY",
		2: "CATALOG_SORT_RATING_DESC",
		3: "CATALOG_SORT_RATING_ASC",
		4: "CATALOG_SORT_RELEASE_DATE_DESC",
		5: "CATALOG_SORT_RELEASE_DATE_ASC",
	}
	CatalogSort_value = map[string]int32{
		"CATALOG_SORT_UNSPECIFIED":       0,
		"CATALOG_SORT_POPULARITY":        1,
		"CATALOG_SORT_RATING_DESC":       2,
		"CATALOG_SORT_RATING_ASC":        3,
		"CATALOG_SORT_RELEASE_DATE_DESC": 4,
		"CATALOG_SORT_RELEASE_DATE_ASC":  5,
	}
)

func (x CatalogSort) Enum() *CatalogSort {
	p := new(CatalogSort)
	*p = x
	return p
}

func (x CatalogSort) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CatalogSort) Descriptor() protoreflect.EnumDescriptor {
	return file_chill_v4_api_proto_enumTypes[18].Descriptor()
}

func (CatalogSort) Type() protoreflect.EnumType {
	return &file_chill_v4_api_proto_enumTypes[18]
}

func (x CatalogSort) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CatalogSort.Descriptor instead.
func (CatalogSort) EnumDescriptor() ([]byte, []int) {
...
type ResolvePlaybackRequest struct {
	...
	Delivery      PlaybackDelivery `protobuf:"varint,2,opt,name=delivery,proto3,enum=chill.v4.PlaybackDelivery" json:"delivery,omitempty"`
...
func (x *ResolvePlaybackRequest) GetFileId() int64 {
	if x != nil {
		return x.FileId
	}
	return 0
...
func (x *ResolvePlaybackRequest) GetDelivery() PlaybackDelivery {
	if x != nil {
		return x.Delivery
	}
	return PlaybackDelivery_PLAYBACK_DELIVERY_UNSPECIFIED
}
...
type ResolvePlaybackResponse struct {
	...
	//
	//	*ResolvePlaybackResponse_Ready
	//	*ResolvePlaybackResponse_Pending
	//	*ResolvePlaybackResponse_Unavailable
	Result        isResolvePlaybackResponse_Result `protobuf_oneof:"result"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResolvePlaybackResponse) GetResult() isResolvePlaybackResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *ResolvePlaybackResponse) GetReady() *PlaybackReady {
	if x != nil {
		if x, ok := x.Result.(*ResolvePlaybackResponse_Ready); ok {
			return x.Ready
		}
	}
	return nil
...
func (x *ResolvePlaybackResponse) GetPending() *PlaybackPending {
	if x != nil {
		if x, ok := x.Result.(*ResolvePlaybackResponse_Pending); ok {
			return x.Pending
		}
	}
	return nil
...
func (x *ResolvePlaybackResponse) GetUnavailable() *PlaybackUnavailable {
	if x != nil {
		if x, ok := x.Result.(*ResolvePlaybackResponse_Unavailable); ok {
...
type isResolvePlaybackResponse_Result interface {
	isResolvePlaybackResponse_Result()
}

type ResolvePlaybackResponse_Ready struct {
	Ready *PlaybackReady `protobuf:"bytes,1,opt,name=ready,proto3,oneof"`
}

type ResolvePlaybackResponse_Pending struct {
	Pending *PlaybackPending `protobuf:"bytes,2,opt,name=pending,proto3,oneof"`
}

type ResolvePlaybackResponse_Unavailable struct {
	Unavailable *PlaybackUnavailable `protobuf:"bytes,3,opt,name=unavailable,proto3,oneof"`
}

func (*ResolvePlaybackResponse_Ready) isResolvePlaybackResponse_Result() {}

func (*ResolvePlaybackResponse_Pending) isResolvePlaybackResponse_Result() {}

func (*ResolvePlaybackResponse_Unavailable) isResolvePlaybackResponse_Result() {}

type PlaybackReady struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Media *PlaybackUrl           `protobuf:"bytes,1,opt,name=media,proto3" json:"media,omitempty"`
	...
	Format *PlaybackFormat `protobuf:"bytes,2,opt,name=format,proto3" json:"format,omitempty"`
...
func (x *PlaybackReady) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlaybackReady) ProtoMessage() {}

func (x *PlaybackReady) ProtoReflect() protoreflect.Message {
	mi := &file_chill_v4_api_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlaybackReady.ProtoReflect.Descriptor instead.
func (*PlaybackReady) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{2}
}

func (x *PlaybackReady) GetMedia() *PlaybackUrl {
	if x != nil {
		return x.Media
	}
	return nil
...
func (x *PlaybackReady) GetFormat() *PlaybackFormat {
	if x != nil {
		return x.Format
	}
	return nil
...
func (x *PlaybackReady) GetSubtitles() []*Subtitle {
	if x != nil {
		return x.Subtitles
	}
	return nil
...
type PlaybackPending struct {
	...
	Reason        PendingReason `protobuf:"varint,1,opt,name=reason,proto3,enum=chill.v4.PendingReason" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PlaybackPending) Reset() {
	*x = PlaybackPending{}
...
func (x *PlaybackPending) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlaybackPending) ProtoMessage() {}

func (x *PlaybackPending) ProtoReflect() protoreflect.Message {
	mi := &file_chill_v4_api_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlaybackPending.ProtoReflect.Descriptor instead.
func (*PlaybackPending) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{3}
}

func (x *PlaybackPending) GetReason() PendingReason {
	if x != nil {
		return x.Reason
	}
	return PendingReason_PENDING_REASON_UNSPECIFIED
}

type PlaybackUnavailable struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Reason        UnavailableReason      `protobuf:"varint,1,opt,name=reason,proto3,enum=chill.v4.UnavailableReason" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PlaybackUnavailable) Reset() {
	*x = PlaybackUnavailable{}
	mi := &file_chill_v4_api_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PlaybackUnavailable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlaybackUnavailable) ProtoMessage() {}

func (x *PlaybackUnavailable) ProtoReflect() protoreflect.Message {
	mi := &file_chill_v4_api_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlaybackUnavailable.ProtoReflect.Descriptor instead.
func (*PlaybackUnavailable) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{4}
}

func (x *PlaybackUnavailable) GetReason() UnavailableReason {
	if x != nil {
		return x.Reason
	}
...
type PlaybackUrl struct {
	...
	//
	//	*PlaybackUrl_ExpiresAt
	//	*PlaybackUrl_ExpiryUnknown
	Expiry        isPlaybackUrl_Expiry `protobuf_oneof:"expiry"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PlaybackUrl) GetExpiry() isPlaybackUrl_Expiry {
	if x != nil {
		return x.Expiry
	}
	return nil
...
func (x *PlaybackUrl) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.Expiry.(*PlaybackUrl_ExpiresAt); ok {
			return x.ExpiresAt
		}
	}
	return nil
...
func (x *PlaybackUrl) GetExpiryUnknown() bool {
	if x != nil {
		if x, ok := x.Expiry.(*PlaybackUrl_ExpiryUnknown); ok {
			return x.ExpiryUnknown
		}
	}
	return false
}

type isPlaybackUrl_Expiry interface {
	isPlaybackUrl_Expiry()
}

type PlaybackUrl_ExpiresAt struct {
	ExpiresAt *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=expires_at,json=expiresAt,proto3,oneof"`
}

type PlaybackUrl_ExpiryUnknown struct {
	ExpiryUnknown bool `protobuf:"varint,3,opt,name=expiry_unknown,json=expiryUnknown,proto3,oneof"`
}

func (*PlaybackUrl_ExpiresAt) isPlaybackUrl_Expiry() {}

func (*PlaybackUrl_ExpiryUnknown) isPlaybackUrl_Expiry() {}

type PlaybackFormat struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Container     Container              `protobuf:"varint,1,opt,name=container,proto3,enum=chill.v4.Container" json:"container,omitempty"`
	VideoCodec    VideoCodec             `protobuf:"varint,2,opt,name=video_codec,json=videoCodec,proto3,enum=chill.v4.VideoCodec" json:"video_codec,omitempty"`
	AudioCodec    AudioCodec             `protobuf:"varint,3,opt,name=audio_codec,json=audioCodec,proto3,enum=chill.v4.AudioCodec" json:"audio_codec,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PlaybackFormat) Reset() {
	*x = PlaybackFormat{}
...
func (x *PlaybackFormat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlaybackFormat) ProtoMessage() {}

func (x *PlaybackFormat) ProtoReflect() protoreflect.Message {
	mi := &file_chill_v4_api_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlaybackFormat.ProtoReflect.Descriptor instead.
func (*PlaybackFormat) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{6}
}

func (x *PlaybackFormat) GetContainer() Container {
	if x != nil {
		return x.Container
	}
...
func (x *PlaybackFormat) GetVideoCodec() VideoCodec {
	if x != nil {
		return x.VideoCodec
	}
...
func (x *PlaybackFormat) GetAudioCodec() AudioCodec {
	if x != nil {
		return x.AudioCodec
	}
...
type Subtitle struct {
	...
	Format        SubtitleFormat `protobuf:"varint,3,opt,name=format,proto3,enum=chill.v4.SubtitleFormat" json:"format,omitempty"`
	Source        *PlaybackUrl   `protobuf:"bytes,4,opt,name=source,proto3" json:"source,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Subtitle) GetSource() *PlaybackUrl {
	if x != nil {
		return x.Source
	}
	return nil
...
type ReleaseInfo struct {
	...
	Season        *int32                 `protobuf:"varint,3,opt,name=season,proto3,oneof" json:"season,omitempty"`
	Episode       *int32                 `protobuf:"varint,4,opt,name=episode,proto3,oneof" json:"episode,omitempty"`
	EpisodeEnd    *int32                 `protobuf:"varint,5,opt,name=episode_end,json=episodeEnd,proto3,oneof" json:"episode_end,omitempty"`
	Part          *int32                 `protobuf:"varint,6,opt,name=part,proto3,oneof" json:"part,omitempty"`
	...
	Codec         string                 `protobuf:"bytes,13,opt,name=codec,proto3" json:"codec,omitempty"`
	Hdr           string                 `protobuf:"bytes,14,opt,name=hdr,proto3" json:"hdr,omitempty"`
	Audio         string                 `protobuf:"bytes,15,opt,name=audio,proto3" json:"audio,omitempty"`
	Group         string                 `protobuf:"bytes,16,opt,name=group,proto3" json:"group,omitempty"`
	Container     string                 `protobuf:"bytes,17,opt,name=container,proto3" json:"container,omitempty"`
	...
	BitDepth      string                 `protobuf:"bytes,21,opt,name=bit_depth,json=bitDepth,proto3" json:"bit_depth,omitempty"`
	Edition       string                 `protobuf:"bytes,22,opt,name=edition,proto3" json:"edition,omitempty"`
	Extended      bool                   `protobuf:"varint,30,opt,name=extended,proto3" json:"extended,omitempty"`
	Hardcoded     bool                   `protobuf:"varint,31,opt,name=hardcoded,proto3" json:"hardcoded,omitempty"`
	Proper        bool                   `protobuf:"varint,32,opt,name=proper,proto3" json:"proper,omitempty"`
	Repack        bool                   `protobuf:"varint,33,opt,name=repack,proto3" json:"repack,omitempty"`
	Remastered    bool                   `protobuf:"varint,34,opt,name=remastered,proto3" json:"remastered,omitempty"`
	Complete      bool                   `protobuf:"varint,35,opt,name=complete,proto3" json:"complete,omitempty"`
	ThreeD        bool                   `protobuf:"varint,36,opt,name=three_d,json=threeD,proto3" json:"three_d,omitempty"`
	Imax          bool                   `protobuf:"varint,37,opt,name=imax,proto3" json:"imax,omitempty"`
	Unrated       bool                   `protobuf:"varint,38,opt,name=unrated,proto3" json:"unrated,omitempty"`
	Widescreen    bool                   `protobuf:"varint,39,opt,name=widescreen,proto3" json:"widescreen,omitempty"`
	Excess        string                 `protobuf:"bytes,50,opt,name=excess,proto3" json:"excess,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReleaseInfo) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *ReleaseInfo) GetYear() int32 {
	if x != nil && x.Year != nil {
		return *x.Year
	}
	return 0
...
func (x *ReleaseInfo) GetSeason() int32 {
...
func (x *ReleaseInfo) GetEpisode() int32 {
...
func (x *ReleaseInfo) GetEpisodeEnd() int32 {
	if x != nil && x.EpisodeEnd != nil {
		return *x.EpisodeEnd
	}
	return 0
}

func (x *ReleaseInfo) GetPart() int32 {
	if x != nil && x.Part != nil {
		return *x.Part
	}
	return 0
...
func (x *ReleaseInfo) GetResolution() string {
	if x != nil {
		return x.Resolution
	}
	return ""
...
func (x *ReleaseInfo) GetQuality() string {
	if x != nil {
		return x.Quality
	}
	return ""
...
func (x *ReleaseInfo) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *ReleaseInfo) GetCodec() string {
	if x != nil {
		return x.Codec
	}
	return ""
...
func (x *ReleaseInfo) GetHdr() string {
	if x != nil {
		return x.Hdr
	}
	return ""
...
func (x *ReleaseInfo) GetAudio() string {
	if x != nil {
		return x.Audio
	}
	return ""
...
func (x *ReleaseInfo) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
func (x *ReleaseInfo) GetContainer() string {
	if x != nil {
		return x.Container
	}
	return ""
...
func (x *ReleaseInfo) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *ReleaseInfo) GetSize() string {
	if x != nil {
		return x.Size
	}
	return ""
...
func (x *ReleaseInfo) GetBitDepth() string {
	if x != nil {
		return x.BitDepth
	}
	return ""
...
func (x *ReleaseInfo) GetExtended() bool {
	if x != nil {
		return x.Extended
	}
	return false
...
func (x *ReleaseInfo) GetHardcoded() bool {
	if x != nil {
		return x.Hardcoded
	}
	return false
...
func (x *ReleaseInfo) GetProper() bool {
	if x != nil {
		return x.Proper
	}
	return false
...
func (x *ReleaseInfo) GetRepack() bool {
	if x != nil {
		return x.Repack
	}
	return false
...
func (x *ReleaseInfo) GetRemastered() bool {
	if x != nil {
		return x.Remastered
	}
	return false
...
func (x *ReleaseInfo) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
func (x *ReleaseInfo) GetThreeD() bool {
	if x != nil {
		return x.ThreeD
	}
	return false
...
func (x *ReleaseInfo) GetImax() bool {
	if x != nil {
		return x.Imax
	}
	return false
...
func (x *ReleaseInfo) GetUnrated() bool {
	if x != nil {
		return x.Unrated
	}
	return false
...
func (x *ReleaseInfo) GetWidescreen() bool {
	if x != nil {
		return x.Widescreen
	}
	return false
...
func (x *ReleaseInfo) GetExcess() string {
	if x != nil {
		return x.Excess
	}
	return ""
...
func (x *SearchResult) GetReleaseInfo() *ReleaseInfo {
	if x != nil {
...
type Movie struct {
	...
	ReleaseDate   string `protobuf:"bytes,17,opt,name=release_date,json=releaseDate,proto3" json:"release_date,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TVShow struct {
	...
	FirstAirDate  string `protobuf:"bytes,12,opt,name=first_air_date,json=firstAirDate,proto3" json:"first_air_date,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TVShow) GetFirstAirDate() string {
	if x != nil {
...
type TVShowDetail struct {
	...
	// Series premiere date as YYYY-MM-DD; empty when unknown.
	FirstAirDate  string `protobuf:"bytes,13,opt,name=first_air_date,json=firstAirDate,proto3" json:"first_air_date,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TVShowDetail) GetFirstAirDate() string {
	if x != nil {
		return x.FirstAirDate
	}
	return ""
...
type UserSettings struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Search        *SearchSettings        `protobuf:"bytes,19,opt,name=search,proto3" json:"search,omitempty"`
	Catalog       *CatalogSettings       `protobuf:"bytes,20,opt,name=catalog,proto3" json:"catalog,omitempty"`
	Download      *DownloadSettings      `protobuf:"bytes,21,opt,name=download,proto3" json:"download,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserSettings) GetCatalog() *CatalogSettings {
	if x != nil {
		return x.Catalog
	}
	return nil
...
func (x *UserSettings) GetDownload() *DownloadSettings {
	if x != nil {
		return x.Download
	}
	return nil
...
type SearchSettings struct {
	...
	FilterNastyResults          bool                        `protobuf:"varint,3,opt,name=filter_nasty_results,json=filterNastyResults,proto3" json:"filter_nasty_results,omitempty"`
	FilterResultsWithNoSeeders  bool                        `protobuf:"varint,4,opt,name=filter_results_with_no_seeders,json=filterResultsWithNoSeeders,proto3" json:"filter_results_with_no_seeders,omitempty"`
	OtherFilters                []OtherFilter               `protobuf:"varint,5,rep,packed,name=other_filters,json=otherFilters,proto3,enum=chill.v4.OtherFilter" json:"other_filters,omitempty"`
	RememberQuickFilters        bool                        `protobuf:"varint,6,opt,name=remember_quick_filters,json=rememberQuickFilters,proto3" json:"remember_quick_filters,omitempty"`
	ResolutionFilters           []ResolutionFilter          `protobuf:"varint,7,rep,packed,name=resolution_filters,json=resolutionFilters,proto3,enum=chill.v4.ResolutionFilter" json:"resolution_filters,omitempty"`
	SearchResultDisplayBehavior SearchResultDisplayBehavior `protobuf:"varint,8,opt,name=search_result_display_behavior,json=searchResultDisplayBehavior,proto3,enum=chill.v4.SearchResultDisplayBehavior" json:"search_result_display_behavior,omitempty"`
	SearchResultTitleBehavior   SearchResultTitleBehavior   `protobuf:"varint,9,opt,name=search_result_title_behavior,json=searchResultTitleBehavior,proto3,enum=chill.v4.SearchResultTitleBehavior" json:"search_result_title_behavior,omitempty"`
	SortBy                      SortBy                      `protobuf:"varint,10,opt,name=sort_by,json=sortBy,proto3,enum=chill.v4.SortBy" json:"sort_by,omitempty"`
	SortDirection               SortDirection               `protobuf:"varint,11,opt,name=sort_direction,json=sortDirection,proto3,enum=chill.v4.SortDirection" json:"sort_direction,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *SearchSettings) GetDisabledIndexerIds() []string {
	if x != nil {
...
func (x *SearchSettings) GetFilterNastyResults() bool {
	if x != nil {
...
func (x *SearchSettings) GetFilterResultsWithNoSeeders() bool {
	if x != nil {
...
func (x *SearchSettings) GetOtherFilters() []OtherFilter {
	if x != nil {
...
func (x *SearchSettings) GetRememberQuickFilters() bool {
	if x != nil {
...
func (x *SearchSettings) GetResolutionFilters() []ResolutionFilter {
	if x != nil {
...
func (x *SearchSettings) GetSearchResultDisplayBehavior() SearchResultDisplayBehavior {
	if x != nil {
...
func (x *SearchSettings) GetSearchResultTitleBehavior() SearchResultTitleBehavior {
	if x != nil {
...
func (x *SearchSettings) GetSortBy() SortBy {
	if x != nil {
		return x.SortBy
	}
...
func (x *SearchSettings) GetSortDirection() SortDirection {
	if x != nil {
...
func (x *CatalogSettings) GetTvShowsSource() TVShowsSource {
	if x != nil {
...
type DownloadSettings struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FolderId      *int64                 `protobuf:"varint,1,opt,name=folder_id,json=folderId,proto3,oneof" json:"folder_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CatalogOrigin struct {
	...
	//
	//	*CatalogOrigin_MoviesSource
	//	*CatalogOrigin_TvShowsSource
	Catalog       isCatalogOrigin_Catalog `protobuf_oneof:"catalog"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CatalogOrigin) Reset() {
	*x = CatalogOrigin{}
...
func (x *CatalogOrigin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CatalogOrigin) ProtoMessage() {}

func (x *CatalogOrigin) ProtoReflect() protoreflect.Message {
	mi := &file_chill_v4_api_proto_msgTypes[51]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CatalogOrigin.ProtoReflect.Descriptor instead.
func (*CatalogOrigin) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{51}
}

func (x *CatalogOrigin) GetCatalog() isCatalogOrigin_Catalog {
	if x != nil {
		return x.Catalog
	}
	return nil
...
func (x *CatalogOrigin) GetMoviesSource() MoviesSource {
	if x != nil {
		if x, ok := x.Catalog.(*CatalogOrigin_MoviesSource); ok {
			return x.MoviesSource
		}
	}
	return MoviesSource_MOVIES_SOURCE_UNSPECIFIED
...
func (x *CatalogOrigin) GetTvShowsSource() TVShowsSource {
	if x != nil {
		if x, ok := x.Catalog.(*CatalogOrigin_TvShowsSource); ok {
			return x.TvShowsSource
		}
	}
	return TVShowsSource_TV_SHOWS_SOURCE_UNSPECIFIED
...
type isCatalogOrigin_Catalog interface {
	isCatalogOrigin_Catalog()
}

type CatalogOrigin_MoviesSource struct {
	MoviesSource MoviesSource `protobuf:"varint,1,opt,name=movies_source,json=moviesSource,proto3,enum=chill.v4.MoviesSource,oneof"`
}

type CatalogOrigin_TvShowsSource struct {
	TvShowsSource TVShowsSource `protobuf:"varint,2,opt,name=tv_shows_source,json=tvShowsSource,proto3,enum=chill.v4.TVShowsSource,oneof"`
}

func (*CatalogOrigin_MoviesSource) isCatalogOrigin_Catalog() {}

func (*CatalogOrigin_TvShowsSource) isCatalogOrigin_Catalog() {}

type AddTransferRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Url           string                 `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"`
	CatalogOrigin *CatalogOrigin         `protobuf:"bytes,2,opt,name=catalog_origin,json=catalogOrigin,proto3" json:"catalog_origin,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AddTransferRequest) GetCatalogOrigin() *CatalogOrigin {
	if x != nil {
...
func (x *GetTransferResponse) Reset() {
	*x = GetTransferResponse{}
	mi := &file_chill_v4_api_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetTransferResponse) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{55}
}
...
func (x *Transfer) Reset() {
	*x = Transfer{}
	mi := &file_chill_v4_api_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Transfer) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{56}
}
...
func (x *GetDownloadFolderRequest) Reset() {
	*x = GetDownloadFolderRequest{}
	mi := &file_chill_v4_api_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetDownloadFolderRequest) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{57}
}
...
func (x *GetDownloadFolderResponse) Reset() {
	*x = GetDownloadFolderResponse{}
	mi := &file_chill_v4_api_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetDownloadFolderResponse) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{58}
}
...
func (x *GetFolderRequest) Reset() {
	*x = GetFolderRequest{}
	mi := &file_chill_v4_api_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetFolderRequest) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{59}
}
...
func (x *UserFile) Reset() {
	*x = UserFile{}
	mi := &file_chill_v4_api_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserFile) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{60}
}
...
func (x *GetFolderResponse) Reset() {
	*x = GetFolderResponse{}
	mi := &file_chill_v4_api_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetFolderResponse) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{61}
}
...
func (x *GetUserProfileRequest) Reset() {
	*x = GetUserProfileRequest{}
	mi := &file_chill_v4_api_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserProfileRequest) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{62}
}
...
func (x *UserProfile) Reset() {
	*x = UserProfile{}
	mi := &file_chill_v4_api_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserProfile) Descriptor() ([]byte, []int) {
	return file_chill_v4_api_proto_rawDescGZIP(), []int{63}
}
...
const file_chill_v4_api_proto_rawDesc = "" +
	"\n" +
	"\x12chill/v4/api.proto\x12\bchill.v4\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"i\n" +
	"\x16ResolvePlaybackRequest\x12\x17\n" +
	"\afile_id\x18\x01 \x01(\x03R\x06fileId\x126\n" +
	"\bdelivery\x18\x02 \x01(\x0e2\x1a.chill.v4.PlaybackDeliveryR\bdelivery\"\xce\x01\n" +
	"\x17ResolvePlaybackResponse\x12/\n" +
	"\x05ready\x18\x01 \x01(\v2\x17.chill.v4.PlaybackReadyH\x00R\x05ready\x125\n" +
	"\apending\x18\x02 \x01(\v2\x19.chill.v4.PlaybackPendingH\x00R\apending\x12A\n" +
	"\vunavailable\x18\x03 \x01(\v2\x1d.chill.v4.PlaybackUnavailableH\x00R\vunavailableB\b\n" +
	"\x06result\"\xa0\x01\n" +
	"\rPlaybackReady\x12+\n" +
	"\x05media\x18\x01 \x01(\v2\x15.chill.v4.PlaybackUrlR\x05media\x120\n" +
	"\x06format\x18\x02 \x01(\v2\x18.chill.v4.PlaybackFormatR\x06format\x120\n" +
	"\tsubtitles\x18\x03 \x03(\v2\x12.chill.v4.SubtitleR\tsubtitles\"B\n" +
	"\x0fPlaybackPending\x12/\n" +
	"\x06reason\x18\x01 \x01(\x0e2\x17.chill.v4.PendingReasonR\x06reason\"J\n" +
	"\x13PlaybackUnavailable\x123\n" +
	"\x06reason\x18\x01 \x01(\x0e2\x1b.chill.v4.UnavailableReasonR\x06reason\"\x8f\x01\n" +
	"\vPlaybackUrl\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12;\n" +
	"\n" +
	"expires_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\texpiresAt\x12'\n" +
	"\x0eexpiry_unknown\x18\x03 \x01(\bH\x00R\rexpiryUnknownB\b\n" +
	"\x06expiry\"\xb1\x01\n" +
	"\x0ePlaybackFormat\x121\n" +
	"\tcontainer\x18\x01 \x01(\x0e2\x13.chill.v4.ContainerR\tcontainer\x125\n" +
	"\vvideo_codec\x18\x02 \x01(\x0e2\x14.chill.v4.VideoCodecR\n" +
	"videoCodec\x125\n" +
	"\vaudio_codec\x18\x03 \x01(\x0e2\x14.chill.v4.AudioCodecR\n" +
	"audioCodec\"\x97\x01\n" +
	"\bSubtitle\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage\x120\n" +
	"\x06format\x18\x03 \x01(\x0e2\x18.chill.v4.SubtitleFormatR\x06format\x12-\n" +
	"\x06source\x18\x04 \x01(\v2\x15.chill.v4.PlaybackUrlR\x06source\"\x14\n" +
	...
	"\x05query\x18\x01 \x01(\tR\x05query\"\xd8\x06\n" +
	"\vReleaseInfo\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x17\n" +
	"\x04year\x18\x02 \x01(\x05H\x00R\x04year\x88\x01\x01\x12\x1b\n" +
	"\x06season\x18\x03 \x01(\x05H\x01R\x06season\x88\x01\x01\x12\x1d\n" +
	"\aepisode\x18\x04 \x01(\x05H\x02R\aepisode\x88\x01\x01\x12$\n" +
	"\vepisode_end\x18\x05 \x01(\x05H\x03R\n" +
	"episodeEnd\x88\x01\x01\x12\x17\n" +
	"\x04part\x18\x06 \x01(\x05H\x04R\x04part\x88\x01\x01\x12\x1e\n" +
	"\n" +
	"resolution\x18\n" +
	" \x01(\tR\n" +
	"resolution\x12\x18\n" +
	"\aquality\x18\v \x01(\tR\aquality\x12\x16\n" +
	"\x06source\x18\f \x01(\tR\x06source\x12\x14\n" +
	"\x05codec\x18\r \x01(\tR\x05codec\x12\x10\n" +
	"\x03hdr\x18\x0e \x01(\tR\x03hdr\x12\x14\n" +
	"\x05audio\x18\x0f \x01(\tR\x05audio\x12\x14\n" +
	"\x05group\x18\x10 \x01(\tR\x05group\x12\x1c\n" +
	"\tcontainer\x18\x11 \x01(\tR\tcontainer\x12\x1a\n" +
	"\blanguage\x18\x12 \x01(\tR\blanguage\x12\x16\n" +
	"\x06region\x18\x13 \x01(\tR\x06region\x12\x12\n" +
	"\x04size\x18\x14 \x01(\tR\x04size\x12\x1b\n" +
	"\tbit_depth\x18\x15 \x01(\tR\bbitDepth\x12\x18\n" +
	"\aedition\x18\x16 \x01(\tR\aedition\x12\x1a\n" +
	"\bextended\x18\x1e \x01(\bR\bextended\x12\x1c\n" +
	"\thardcoded\x18\x1f \x01(\bR\thardcoded\x12\x16\n" +
	"\x06proper\x18  \x01(\bR\x06proper\x12\x16\n" +
	"\x06repack\x18! \x01(\bR\x06repack\x12\x1e\n" +
	"\n" +
	"remastered\x18\" \x01(\bR\n" +
	"remastered\x12\x1a\n" +
	"\bcomplete\x18# \x01(\bR\bcomplete\x12\x17\n" +
	"\athree_d\x18$ \x01(\bR\x06threeD\x12\x12\n" +
	"\x04imax\x18% \x01(\bR\x04imax\x12\x18\n" +
	"\aunrated\x18& \x01(\bR\aunrated\x12\x1e\n" +
	"\n" +
	"widescreen\x18' \x01(\bR\n" +
	"widescreen\x12\x16\n" +
	"\x06excess\x182 \x01(\tR\x06excessB\a\n" +
	"\x05_yearB\t\n" +
	"\a_seasonB\n" +
	"\n" +
	"\b_episodeB\x0e\n" +
	...
	"\x06source\x18\x01 \x01(\x0e2\x16.chill.v4.MoviesSourceR\x06source\"\xf5\x03\n" +
	"\x05Movie\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	...
	"\frelease_date\x18\x11 \x01(\tR\vreleaseDate:\x12\x92A\x0f\n" +
	"\r\xd2\x01\n" +
	"poster_url\"t\n" +
	...
	"\bnetworks\x18\v \x03(\tR\bnetworks\x12$\n" +
	"\x0efirst_air_date\x18\f \x01(\tR\ffirstAirDate:\x1c\x92A\x19\n" +
	...
	"\x05shows\x18\x02 \x03(\v2\x10.chill.v4.TVShowR\x05shows\"D\n" +
	"\x11GetTVShowsRequest\x12/\n" +
	"\x06source\x18\x01 \x01(\x0e2\x17.chill.v4.TVShowsSourceR\x06source\"m\n" +
	"\x12GetTVShowsResponse\x12/\n" +
	"\x06source\x18\x01 \x01(\x0e2\x17.chill.v4.TVShowsSourceR\x06source\x12&\n" +
	"\x05shows\x18\x02 \x03(\v2\x10.chill.v4.TVShowR\x05shows\"\x97\x03\n" +
	...
	"\x06genres\x18\f \x03(\tR\x06genres\x12$\n" +
	"\x0efirst_air_date\x18\r \x01(\tR\ffirstAirDate\"\xa6\x01\n" +
	"\fTVShowSeason\x12#\n" +
	...
	"\t_download\"\x18\n" +
	"\x16GetUserSettingsRequest\"\xa8\x04\n" +
	"\fUserSettings\x120\n" +
	...
	"\x1e\xd2\x01\x06search\xd2\x01\acatalog\xd2\x01\bdownloadJ\x04\b\x01\x10\x13R\rcodec_filtersR\x14disabled_indexer_idsR\x12download_folder_idR\x14filter_nasty_resultsR\x1efilter_results_with_no_seedersR\rother_filtersR\x16remember_quick_filtersR\x12resolution_filtersR\x1esearch_result_display_behaviorR\x1csearch_result_title_behaviorR\vshow_moviesR\asort_byR\x0esort_directionR\x11card_display_typeR\rmovies_sourceR\rshow_tv_showsR\x0ftv_shows_source\"\xee\x05\n" +
	"\x0eSearchSettings\x12:\n" +
	"\rcodec_filters\x18\x01 \x03(\x0e2\x15.chill.v4.CodecFilterR\fcodecFilters\x120\n" +
	"\x14disabled_indexer_ids\x18\x02 \x03(\tR\x12disabledIndexerIds\x120\n" +
	"\x14filter_nasty_results\x18\x03 \x01(\bR\x12filterNastyResults\x12B\n" +
	"\x1efilter_results_with_no_seeders\x18\x04 \x01(\bR\x1afilterResultsWithNoSeeders\x12:\n" +
	"\rother_filters\x18\x05 \x03(\x0e2\x15.chill.v4.OtherFilterR\fotherFilters\x124\n" +
	"\x16remember_quick_filters\x18\x06 \x01(\bR\x14rememberQuickFilters\x12I\n" +
	"\x12resolution_filters\x18\a \x03(\x0e2\x1a.chill.v4.ResolutionFilterR\x11resolutionFilters\x12j\n" +
	"\x1esearch_result_display_behavior\x18\b \x01(\x0e2%.chill.v4.SearchResultDisplayBehaviorR\x1bsearchResultDisplayBehavior\x12d\n" +
	...
	"\bsettings\x18\x01 \x01(\v2\x16.chill.v4.UserSettingsR\bsettings\"\x9c\x01\n" +
	"\rCatalogOrigin\x12=\n" +
	"\rmovies_source\x18\x01 \x01(\x0e2\x16.chill.v4.MoviesSourceH\x00R\fmoviesSource\x12A\n" +
	"\x0ftv_shows_source\x18\x02 \x01(\x0e2\x17.chill.v4.TVShowsSourceH\x00R\rtvShowsSourceB\t\n" +
	"\acatalog\"f\n" +
	"\x12AddTransferRequest\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12>\n" +
	"\x0ecatalog_origin\x18\x02 \x01(\v2\x17.chill.v4.CatalogOriginR\rcatalogOrigin\"]\n" +
	...
	"\x10PlaybackDelivery\x12!\n" +
	"\x1dPLAYBACK_DELIVERY_UNSPECIFIED\x10\x00\x12\x1e\n" +
	"\x1aPLAYBACK_DELIVERY_ORIGINAL\x10\x01\x12\x19\n" +
	"\x15PLAYBACK_DELIVERY_HLS\x10\x02*N\n" +
	"\rPendingReason\x12\x1e\n" +
	"\x1aPENDING_REASON_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19PENDING_REASON_PROCESSING\x10\x01*\xaf\x01\n" +
	"\x11UnavailableReason\x12\"\n" +
	"\x1eUNAVAILABLE_REASON_UNSPECIFIED\x10\x00\x12 \n" +
	"\x1cUNAVAILABLE_REASON_NOT_FOUND\x10\x01\x12)\n" +
	"%UNAVAILABLE_REASON_UNSUPPORTED_FORMAT\x10\x02\x12)\n" +
	"%UNAVAILABLE_REASON_NO_PLAYABLE_SOURCE\x10\x03*9\n" +
	"\tContainer\x12\x19\n" +
	"\x15CONTAINER_UNSPECIFIED\x10\x00\x12\x11\n" +
	"\rCONTAINER_MP4\x10\x01*?\n" +
	"\n" +
	"VideoCodec\x12\x1b\n" +
	"\x17VIDEO_CODEC_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10VIDEO_CODEC_H264\x10\x01*>\n" +
	"\n" +
	"AudioCodec\x12\x1b\n" +
	"\x17AUDIO_CODEC_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fAUDIO_CODEC_AAC\x10\x01*c\n" +
	"\x0eSubtitleFormat\x12\x1f\n" +
	"\x1bSUBTITLE_FORMAT_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13SUBTITLE_FORMAT_VTT\x10\x01\x12\x17\n" +
	"\x13SUBTITLE_FORMAT_SRT\x10\x02*\x81\x01\n" +
	...
	"\x13MOVIES_SOURCE_TRAKT\x10\x05*\xeb\x02\n" +
	...
	"\x1bTV_SHOWS_SOURCE_DISNEY_PLUS\x10\x05\x12!\n" +
	"\x1dTV_SHOWS_SOURCE_ALL_PROVIDERS\x10\x06\x12\x18\n" +
	"\x14TV_SHOWS_SOURCE_HULU\x10\a\x12\"\n" +
	"\x1eTV_SHOWS_SOURCE_PARAMOUNT_PLUS\x10\b\x12\x1c\n" +
	"\x18TV_SHOWS_SOURCE_AMC_PLUS\x10\t\x12\x1b\n" +
	"\x17TV_SHOWS_SOURCE_PEACOCK\x10\n" +
	"*\xc1\x01\n" +
	...
	"\x13SORT_DIRECTION_DESC\x10\x02*\xca\x01\n" +
	"\vCatalogSort\x12\x1c\n" +
	"\x18CATALOG_SORT_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17CATALOG_SORT_POPULARITY\x10\x01\x12\x1c\n" +
	"\x18CATALOG_SORT_RATING_DESC\x10\x02\x12\x1b\n" +
	"\x17CATALOG_SORT_RATING_ASC\x10\x03\x12\"\n" +
	"\x1eCATALOG_SORT_RELEASE_DATE_DESC\x10\x04\x12!\n" +
	"\x1dCATALOG_SORT_RELEASE_DATE_ASC\x10\x052\xc3\x05\n" +
	"\vCoreService\x12}\n" +
	...
	"ApiKeyAuth\x12\x00r\x1f\n" +
	"\x1d\n" +
	"\tX-API-Key\x12\fCore API key\x18\x01(\x012\xd4\x15\n" +
	...
	"BearerAuth\x12\x00r?\n" +
	"=\n" +
	"\rAuthorization\x12(User auth token. Format: Bearer <token>.\x18\x01(\x01\x12\xb1\x01\n" +
	"\x0fResolvePlayback\x12 .chill.v4.ResolvePlaybackRequest\x1a!.chill.v4.ResolvePlaybackResponse\"Y\x92ASb\x10\n" +
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00r?\n" +
	"=\n" +
	"\rAuthorization\x12(User auth token. Format: Bearer <token>.\x18\x01(\x01\x90\x02\x01\x12\xa0\x01\n" +
	"\x0eGetUserProfile\x12\x1f.chill.v4.GetUserProfileRequest\x1a\x15.chill.v4.UserProfile\"V\x92ASb\x10\n" +
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00r?\n" +
	"=\n" +
	"\rAuthorization\x12(User auth token. Format: Bearer <token>.\x18\x01(\x01B\x93\x03\x92A\xef\x01\x12\x15\n" +
...
var file_chill_v4_api_proto_enumTypes = make([]protoimpl.EnumInfo, 19)
var file_chill_v4_api_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_chill_v4_api_proto_goTypes = []any{
	(PlaybackDelivery)(0),                    // 0: chill.v4.PlaybackDelivery
	(PendingReason)(0),                       // 1: chill.v4.PendingReason
	(UnavailableReason)(0),                   // 2: chill.v4.UnavailableReason
	(Container)(0),                           // 3: chill.v4.Container
	(VideoCodec)(0),                          // 4: chill.v4.VideoCodec
	(AudioCodec)(0),                          // 5: chill.v4.AudioCodec
	(SubtitleFormat)(0),                      // 6: chill.v4.SubtitleFormat
	(IndexerStatus)(0),                       // 7: chill.v4.IndexerStatus
	(MoviesSource)(0),                        // 8: chill.v4.MoviesSource
	(TVShowsSource)(0),                       // 9: chill.v4.TVShowsSource
	(TVShowStatus)(0),                        // 10: chill.v4.TVShowStatus
	(ResolutionFilter)(0),                    // 11: chill.v4.ResolutionFilter
	(CodecFilter)(0),                         // 12: chill.v4.CodecFilter
	(OtherFilter)(0),                         // 13: chill.v4.OtherFilter
	(SearchResultDisplayBehavior)(0),         // 14: chill.v4.SearchResultDisplayBehavior
	(SearchResultTitleBehavior)(0),           // 15: chill.v4.SearchResultTitleBehavior
	(SortBy)(0),                              // 16: chill.v4.SortBy
	(SortDirection)(0),                       // 17: chill.v4.SortDirection
	(CatalogSort)(0),                         // 18: chill.v4.CatalogSort
	(*ResolvePlaybackRequest)(nil),           // 19: chill.v4.ResolvePlaybackRequest
	(*ResolvePlaybackResponse)(nil),          // 20: chill.v4.ResolvePlaybackResponse
	(*PlaybackReady)(nil),                    // 21: chill.v4.PlaybackReady
	(*PlaybackPending)(nil),                  // 22: chill.v4.PlaybackPending
	(*PlaybackUnavailable)(nil),              // 23: chill.v4.PlaybackUnavailable
	(*PlaybackUrl)(nil),                      // 24: chill.v4.PlaybackUrl
	(*PlaybackFormat)(nil),                   // 25: chill.v4.PlaybackFormat
	(*Subtitle)(nil),                         // 26: chill.v4.Subtitle
	(*HealthCheckRequest)(nil),               // 27: chill.v4.HealthCheckRequest
	(*HealthResponse)(nil),                   // 28: chill.v4.HealthResponse
	(*CoreGetIndexersRequest)(nil),           // 29: chill.v4.CoreGetIndexersRequest
	(*Indexer)(nil),                          // 30: chill.v4.Indexer
	(*CoreGetIndexersResponse)(nil),          // 31: chill.v4.CoreGetIndexersResponse
	(*UserGetIndexersRequest)(nil),           // 32: chill.v4.UserGetIndexersRequest
	(*UserGetIndexersResponse)(nil),          // 33: chill.v4.UserGetIndexersResponse
	(*UserIndexer)(nil),                      // 34: chill.v4.UserIndexer
	(*CoreSearchRequest)(nil),                // 35: chill.v4.CoreSearchRequest
	(*ReleaseInfo)(nil),                      // 36: chill.v4.ReleaseInfo
	(*SearchResult)(nil),                     // 37: chill.v4.SearchResult
	(*SearchResponse)(nil),                   // 38: chill.v4.SearchResponse
	(*IndexerStat)(nil),                      // 39: chill.v4.IndexerStat
	(*UserSearchRequest)(nil),                // 40: chill.v4.UserSearchRequest
	(*GetMoviesBySourceRequest)(nil),         // 41: chill.v4.GetMoviesBySourceRequest
	(*Movie)(nil),                            // 42: chill.v4.Movie
	(*GetMoviesBySourceResponse)(nil),        // 43: chill.v4.GetMoviesBySourceResponse
	(*GetMoviesRequest)(nil),                 // 44: chill.v4.GetMoviesRequest
	(*GetMoviesResponse)(nil),                // 45: chill.v4.GetMoviesResponse
	(*TVShow)(nil),                           // 46: chill.v4.TVShow
	(*GetTVShowsBySourceRequest)(nil),        // 47: chill.v4.GetTVShowsBySourceRequest
	(*GetTVShowsBySourceResponse)(nil),       // 48: chill.v4.GetTVShowsBySourceResponse
	(*GetTVShowsRequest)(nil),                // 49: chill.v4.GetTVShowsRequest
	(*GetTVShowsResponse)(nil),               // 50: chill.v4.GetTVShowsResponse
	(*TVShowDetail)(nil),                     // 51: chill.v4.TVShowDetail
	(*TVShowSeason)(nil),                     // 52: chill.v4.TVShowSeason
	(*TVShowEpisode)(nil),                    // 53: chill.v4.TVShowEpisode
	(*GetTVShowDetailRequest)(nil),           // 54: chill.v4.GetTVShowDetailRequest
	(*GetTVShowDetailResponse)(nil),          // 55: chill.v4.GetTVShowDetailResponse
	(*GetTVShowSeasonRequest)(nil),           // 56: chill.v4.GetTVShowSeasonRequest
	(*GetTVShowSeasonResponse)(nil),          // 57: chill.v4.GetTVShowSeasonResponse
	(*TVShowDownload)(nil),                   // 58: chill.v4.TVShowDownload
	(*GetTVShowEpisodeDownloadRequest)(nil),  // 59: chill.v4.GetTVShowEpisodeDownloadRequest
	(*GetTVShowEpisodeDownloadResponse)(nil), // 60: chill.v4.GetTVShowEpisodeDownloadResponse
	(*GetTVShowSeasonDownloadsRequest)(nil),  // 61: chill.v4.GetTVShowSeasonDownloadsRequest
	(*GetTVShowSeasonDownloadsResponse)(nil), // 62: chill.v4.GetTVShowSeasonDownloadsResponse
	(*TVShowEpisodeDownloadResult)(nil),      // 63: chill.v4.TVShowEpisodeDownloadResult
	(*GetUserSettingsRequest)(nil),           // 64: chill.v4.GetUserSettingsRequest
	(*UserSettings)(nil),                     // 65: chill.v4.UserSettings
	(*SearchSettings)(nil),                   // 66: chill.v4.SearchSettings
	(*CatalogSettings)(nil),                  // 67: chill.v4.CatalogSettings
	(*DownloadSettings)(nil),                 // 68: chill.v4.DownloadSettings
	(*SaveUserSettingsRequest)(nil),          // 69: chill.v4.SaveUserSettingsRequest
	(*CatalogOrigin)(nil),                    // 70: chill.v4.CatalogOrigin
	(*AddTransferRequest)(nil),               // 71: chill.v4.AddTransferRequest
	(*AddTransferResponse)(nil),              // 72: chill.v4.AddTransferResponse
	(*GetTransferRequest)(nil),               // 73: chill.v4.GetTransferRequest
	(*GetTransferResponse)(nil),              // 74: chill.v4.GetTransferResponse
	(*Transfer)(nil),                         // 75: chill.v4.Transfer
	(*GetDownloadFolderRequest)(nil),         // 76: chill.v4.GetDownloadFolderRequest
	(*GetDownloadFolderResponse)(nil),        // 77: chill.v4.GetDownloadFolderResponse
	(*GetFolderRequest)(nil),                 // 78: chill.v4.GetFolderRequest
	(*UserFile)(nil),                         // 79: chill.v4.UserFile
	(*GetFolderResponse)(nil),                // 80: chill.v4.GetFolderResponse
	(*GetUserProfileRequest)(nil),            // 81: chill.v4.GetUserProfileRequest
	(*UserProfile)(nil),                      // 82: chill.v4.UserProfile
	(*timestamppb.Timestamp)(nil),            // 83: google.protobuf.Timestamp
}
var file_chill_v4_api_proto_depIdxs = []int32{
	0,  // 0: chill.v4.ResolvePlaybackRequest.delivery:type_name -> chill.v4.PlaybackDelivery
	21, // 1: chill.v4.ResolvePlaybackResponse.ready:type_name -> chill.v4.PlaybackReady
	22, // 2: chill.v4.ResolvePlaybackResponse.pending:type_name -> chill.v4.PlaybackPending
	23, // 3: chill.v4.ResolvePlaybackResponse.unavailable:type_name -> chill.v4.PlaybackUnavailable
	24, // 4: chill.v4.PlaybackReady.media:type_name -> chill.v4.PlaybackUrl
	25, // 5: chill.v4.PlaybackReady.format:type_name -> chill.v4.PlaybackFormat
	26, // 6: chill.v4.PlaybackReady.subtitles:type_name -> chill.v4.Subtitle
	1,  // 7: chill.v4.PlaybackPending.reason:type_name -> chill.v4.PendingReason
	2,  // 8: chill.v4.PlaybackUnavailable.reason:type_name -> chill.v4.UnavailableReason
	83, // 9: chill.v4.PlaybackUrl.expires_at:type_name -> google.protobuf.Timestamp
	3,  // 10: chill.v4.PlaybackFormat.container:type_name -> chill.v4.Container
	4,  // 11: chill.v4.PlaybackFormat.video_codec:type_name -> chill.v4.VideoCodec
	5,  // 12: chill.v4.PlaybackFormat.audio_codec:type_name -> chill.v4.AudioCodec
	6,  // 13: chill.v4.Subtitle.format:type_name -> chill.v4.SubtitleFormat
	24, // 14: chill.v4.Subtitle.source:type_name -> chill.v4.PlaybackUrl
	7,  // 15: chill.v4.Indexer.status:type_name -> chill.v4.IndexerStatus
	30, // 16: chill.v4.CoreGetIndexersResponse.indexers:type_name -> chill.v4.Indexer
	34, // 17: chill.v4.UserGetIndexersResponse.indexers:type_name -> chill.v4.UserIndexer
	7,  // 18: chill.v4.UserIndexer.status:type_name -> chill.v4.IndexerStatus
	36, // 19: chill.v4.SearchResult.release_info:type_name -> chill.v4.ReleaseInfo
	37, // 20: chill.v4.SearchResponse.results:type_name -> chill.v4.SearchResult
	39, // 21: chill.v4.SearchResponse.indexer_stats:type_name -> chill.v4.IndexerStat
	8,  // 22: chill.v4.GetMoviesBySourceRequest.source:type_name -> chill.v4.MoviesSource
	8,  // 23: chill.v4.Movie.source:type_name -> chill.v4.MoviesSource
	8,  // 24: chill.v4.GetMoviesBySourceResponse.source:type_name -> chill.v4.MoviesSource
	42, // 25: chill.v4.GetMoviesBySourceResponse.movies:type_name -> chill.v4.Movie
	8,  // 26: chill.v4.GetMoviesResponse.source:type_name -> chill.v4.MoviesSource
	42, // 27: chill.v4.GetMoviesResponse.movies:type_name -> chill.v4.Movie
	9,  // 28: chill.v4.TVShow.source:type_name -> chill.v4.TVShowsSource
	10, // 29: chill.v4.TVShow.status:type_name -> chill.v4.TVShowStatus
	9,  // 30: chill.v4.GetTVShowsBySourceRequest.source:type_name -> chill.v4.TVShowsSource
	9,  // 31: chill.v4.GetTVShowsBySourceResponse.source:type_name -> chill.v4.TVShowsSource
	46, // 32: chill.v4.GetTVShowsBySourceResponse.shows:type_name -> chill.v4.TVShow
	9,  // 33: chill.v4.GetTVShowsRequest.source:type_name -> chill.v4.TVShowsSource
	9,  // 34: chill.v4.GetTVShowsResponse.source:type_name -> chill.v4.TVShowsSource
	46, // 35: chill.v4.GetTVShowsResponse.shows:type_name -> chill.v4.TVShow
	10, // 36: chill.v4.TVShowDetail.status:type_name -> chill.v4.TVShowStatus
	51, // 37: chill.v4.GetTVShowDetailResponse.show:type_name -> chill.v4.TVShowDetail
	52, // 38: chill.v4.GetTVShowDetailResponse.seasons:type_name -> chill.v4.TVShowSeason
	52, // 39: chill.v4.GetTVShowSeasonResponse.season:type_name -> chill.v4.TVShowSeason
	53, // 40: chill.v4.GetTVShowSeasonResponse.episodes:type_name -> chill.v4.TVShowEpisode
	58, // 41: chill.v4.GetTVShowEpisodeDownloadResponse.download:type_name -> chill.v4.TVShowDownload
	58, // 42: chill.v4.GetTVShowSeasonDownloadsResponse.season_pack:type_name -> chill.v4.TVShowDownload
	63, // 43: chill.v4.GetTVShowSeasonDownloadsResponse.episodes:type_name -> chill.v4.TVShowEpisodeDownloadResult
	58, // 44: chill.v4.TVShowEpisodeDownloadResult.download:type_name -> chill.v4.TVShowDownload
	66, // 45: chill.v4.UserSettings.search:type_name -> chill.v4.SearchSettings
	67, // 46: chill.v4.UserSettings.catalog:type_name -> chill.v4.CatalogSettings
	68, // 47: chill.v4.UserSettings.download:type_name -> chill.v4.DownloadSettings
	12, // 48: chill.v4.SearchSettings.codec_filters:type_name -> chill.v4.CodecFilter
	13, // 49: chill.v4.SearchSettings.other_filters:type_name -> chill.v4.OtherFilter
	11, // 50: chill.v4.SearchSettings.resolution_filters:type_name -> chill.v4.ResolutionFilter
	14, // 51: chill.v4.SearchSettings.search_result_display_behavior:type_name -> chill.v4.SearchResultDisplayBehavior
	15, // 52: chill.v4.SearchSettings.search_result_title_behavior:type_name -> chill.v4.SearchResultTitleBehavior
	16, // 53: chill.v4.SearchSettings.sort_by:type_name -> chill.v4.SortBy
	17, // 54: chill.v4.SearchSettings.sort_direction:type_name -> chill.v4.SortDirection
	8,  // 55: chill.v4.CatalogSettings.movies_source:type_name -> chill.v4.MoviesSource
	9,  // 56: chill.v4.CatalogSettings.tv_shows_source:type_name -> chill.v4.TVShowsSource
	18, // 57: chill.v4.CatalogSettings.movies_sort:type_name -> chill.v4.CatalogSort
	18, // 58: chill.v4.CatalogSettings.tv_shows_sort:type_name -> chill.v4.CatalogSort
	18, // 59: chill.v4.CatalogSettings.sort:type_name -> chill.v4.CatalogSort
	65, // 60: chill.v4.SaveUserSettingsRequest.settings:type_name -> chill.v4.UserSettings
	8,  // 61: chill.v4.CatalogOrigin.movies_source:type_name -> chill.v4.MoviesSource
	9,  // 62: chill.v4.CatalogOrigin.tv_shows_source:type_name -> chill.v4.TVShowsSource
	70, // 63: chill.v4.AddTransferRequest.catalog_origin:type_name -> chill.v4.CatalogOrigin
	75, // 64: chill.v4.AddTransferResponse.transfer:type_name -> chill.v4.Transfer
	75, // 65: chill.v4.GetTransferResponse.transfer:type_name -> chill.v4.Transfer
	79, // 66: chill.v4.GetDownloadFolderResponse.folder:type_name -> chill.v4.UserFile
	79, // 67: chill.v4.GetFolderResponse.parent:type_name -> chill.v4.UserFile
	79, // 68: chill.v4.GetFolderResponse.files:type_name -> chill.v4.UserFile
	27, // 69: chill.v4.CoreService.HealthCheck:input_type -> chill.v4.HealthCheckRequest
	29, // 70: chill.v4.CoreService.GetIndexers:input_type -> chill.v4.CoreGetIndexersRequest
	35, // 71: chill.v4.CoreService.Search:input_type -> chill.v4.CoreSearchRequest
	41, // 72: chill.v4.CoreService.GetMoviesBySource:input_type -> chill.v4.GetMoviesBySourceRequest
	47, // 73: chill.v4.CoreService.GetTVShowsBySource:input_type -> chill.v4.GetTVShowsBySourceRequest
	32, // 74: chill.v4.UserService.GetIndexers:input_type -> chill.v4.UserGetIndexersRequest
	40, // 75: chill.v4.UserService.Search:input_type -> chill.v4.UserSearchRequest
	44, // 76: chill.v4.UserService.GetMovies:input_type -> chill.v4.GetMoviesRequest
	49, // 77: chill.v4.UserService.GetTVShows:input_type -> chill.v4.GetTVShowsRequest
	54, // 78: chill.v4.UserService.GetTVShowDetail:input_type -> chill.v4.GetTVShowDetailRequest
	56, // 79: chill.v4.UserService.GetTVShowSeason:input_type -> chill.v4.GetTVShowSeasonRequest
	59, // 80: chill.v4.UserService.GetTVShowEpisodeDownload:input_type -> chill.v4.GetTVShowEpisodeDownloadRequest
	61, // 81: chill.v4.UserService.GetTVShowSeasonDownloads:input_type -> chill.v4.GetTVShowSeasonDownloadsRequest
	64, // 82: chill.v4.UserService.GetUserSettings:input_type -> chill.v4.GetUserSettingsRequest
	69, // 83: chill.v4.UserService.SaveUserSettings:input_type -> chill.v4.SaveUserSettingsRequest
	71, // 84: chill.v4.UserService.AddTransfer:input_type -> chill.v4.AddTransferRequest
	73, // 85: chill.v4.UserService.GetTransfer:input_type -> chill.v4.GetTransferRequest
	76, // 86: chill.v4.UserService.GetDownloadFolder:input_type -> chill.v4.GetDownloadFolderRequest
	78, // 87: chill.v4.UserService.GetFolder:input_type -> chill.v4.GetFolderRequest
	19, // 88: chill.v4.UserService.ResolvePlayback:input_type -> chill.v4.ResolvePlaybackRequest
	81, // 89: chill.v4.UserService.GetUserProfile:input_type -> chill.v4.GetUserProfileRequest
	28, // 90: chill.v4.CoreService.HealthCheck:output_type -> chill.v4.HealthResponse
	31, // 91: chill.v4.CoreService.GetIndexers:output_type -> chill.v4.CoreGetIndexersResponse
	38, // 92: chill.v4.CoreService.Search:output_type -> chill.v4.SearchResponse
	43, // 93: chill.v4.CoreService.GetMoviesBySource:output_type -> chill.v4.GetMoviesBySourceResponse
	48, // 94: chill.v4.CoreService.GetTVShowsBySource:output_type -> chill.v4.GetTVShowsBySourceResponse
	33, // 95: chill.v4.UserService.GetIndexers:output_type -> chill.v4.UserGetIndexersResponse
	38, // 96: chill.v4.UserService.Search:output_type -> chill.v4.SearchResponse
	45, // 97: chill.v4.UserService.GetMovies:output_type -> chill.v4.GetMoviesResponse
	50, // 98: chill.v4.UserService.GetTVShows:output_type -> chill.v4.GetTVShowsResponse
	55, // 99: chill.v4.UserService.GetTVShowDetail:output_type -> chill.v4.GetTVShowDetailResponse
	57, // 100: chill.v4.UserService.GetTVShowSeason:output_type -> chill.v4.GetTVShowSeasonResponse
	60, // 101: chill.v4.UserService.GetTVShowEpisodeDownload:output_type -> chill.v4.GetTVShowEpisodeDownloadResponse
	62, // 102: chill.v4.UserService.GetTVShowSeasonDownloads:output_type -> chill.v4.GetTVShowSeasonDownloadsResponse
	65, // 103: chill.v4.UserService.GetUserSettings:output_type -> chill.v4.UserSettings
	65, // 104: chill.v4.UserService.SaveUserSettings:output_type -> chill.v4.UserSettings
	72, // 105: chill.v4.UserService.AddTransfer:output_type -> chill.v4.AddTransferResponse
	74, // 106: chill.v4.UserService.GetTransfer:output_type -> chill.v4.GetTransferResponse
	77, // 107: chill.v4.UserService.GetDownloadFolder:output_type -> chill.v4.GetDownloadFolderResponse
	80, // 108: chill.v4.UserService.GetFolder:output_type -> chill.v4.GetFolderResponse
	20, // 109: chill.v4.UserService.ResolvePlayback:output_type -> chill.v4.ResolvePlaybackResponse
	82, // 110: chill.v4.UserService.GetUserProfile:output_type -> chill.v4.UserProfile
...
func file_chill_v4_api_proto_init() {
	...
	file_chill_v4_api_proto_msgTypes[1].OneofWrappers = []any{
		(*ResolvePlaybackResponse_Ready)(nil),
		(*ResolvePlaybackResponse_Pending)(nil),
		(*ResolvePlaybackResponse_Unavailable)(nil),
	}
	file_chill_v4_api_proto_msgTypes[5].OneofWrappers = []any{
		(*PlaybackUrl_ExpiresAt)(nil),
		(*PlaybackUrl_ExpiryUnknown)(nil),
	}
	file_chill_v4_api_proto_msgTypes[11].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[15].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[17].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[18].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[21].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[39].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[41].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[43].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[44].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[48].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[49].OneofWrappers = []any{}
	file_chill_v4_api_proto_msgTypes[51].OneofWrappers = []any{
		(*CatalogOrigin_MoviesSource)(nil),
		(*CatalogOrigin_TvShowsSource)(nil),
	}
	file_chill_v4_api_proto_msgTypes[56].OneofWrappers = []any{}
	type x struct{}
